...
export default function ProcessPPS() {
  return (
    <section className="w-full py-16 md:py-20 bg-gray-50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* HEADER */}
        <p className="text-center text-sm font-semibold text-[#1E4ED8] mb-3">
            Proses Produksi
        </p>

        <h2 className="text-center text-3xl md:text-5xl font-bold text-[#113972] leading-[1.15] tracking-[-0.5px]">
            Alur Produksi Terstruktur

        <br />

        <span className="text-center text-[#1E4ED8]">
